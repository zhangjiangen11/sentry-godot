...
- Bump gdUnit 4 from v5.1.0-9-g7546f43 to v5.1.0 ([#2](https://github.com/zhangjiangen11/sentry-godot/pull/2))
  - [changelog](https://github.com/MikeSchulze/gdUnit4/blob/master/CHANGELOG.md#v510)
  - [diff](https://github.com/MikeSchulze/gdUnit4/compare/v5.1.0-9-g7546f43...v5.1.0)
